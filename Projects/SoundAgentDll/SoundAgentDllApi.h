...
#ifndef SOUND_AGENT_DLL_API_H
#define SOUND_AGENT_DLL_API_H
...
#define AC_EXPORT_IMPORT_DECL __declspec(dllimport)
    ...
    /**
     * @typedef AcHandle
     * @brief Handle type used to identify a specific sound agent session.
     */
     ...
     * @brief Callback type for audio device discovery events.
     *
     * This callback function is invoked when an audio device is either attached
     * or detached.
     *
     * @param hint Indicates whether the audio device is being attached (TAcAttachedEvent), detached (TAcDetachedEvent) or volume changed TAcVolumeChangedEvent
     */
     ...
     * the operation of the sound agent DLL.
     *
    ...
    /**
     * @brief Initializes the sound agent session.
     *
     * This function initializes the sound agent  session and provides a handle
     ...
     * @param[in] deviceFilter Filter string for selecting specific audio devices.
     * @param[in, optional] eventCallback Callback function for audio device events.
     ...
     * to the specified sound agent session.
     *
     * @param[in] handle The handle identifying the sound agent session.
    ...
    /**
     * @brief Uninitializes the sound agent session.
     *
     * This function uninitializes the sound agent session and releases any resources
     * associated with it.
     *
